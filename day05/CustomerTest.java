...
public class CustomerTest {
	...
	public void test() throws Exception {
		...
		Customer cus1= new Customer("Abcd",Diamond,"2001-09-25",23000);
		Customer cus2= new Customer("efgh",Platinum,"2001-09-13",23000);
  	    Customer cus3= new Customer("hii",Diamond,"2001-08-25",5400);
        Customer cus4= new Customer("hello",Platinum,"2001-09-10",54000);
        Customer cus5= new Customer("world",gold,"2001-10-25",5400);
        Customer cus6= new Customer("world",silver,"2001-10-25",5400);
        Customer cus7= new Customer("ptyb",Diamond,"2001-11-25",5400);
